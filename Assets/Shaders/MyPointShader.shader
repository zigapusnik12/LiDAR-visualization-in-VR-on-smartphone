Shader "Custom/MyPointShader"
{
    Properties
    { 
        _Default("Default Color", Color) = (1, 1, 1, 1)
        _Tint("Tint", Color) = (0.5, 0.5, 0.5, 1)
        _PointSize("Point Size", Float) = 0.05
        [Toggle] _Distance("Apply Distance", Float) = 1
        [Toggle] _Las("Apply Las Colors", Float) = 0
    }
        SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile _ _LAS_ON
            ...
            #else                
                half4 c = half4(_Default.rgb, _Tint.a);
            #endif
